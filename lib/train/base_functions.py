    ...
    for name in name_list:
        ...
        if name == "GOT10K_train_full":
            if settings.use_lmdb:
                ...
                datasets.append(Got10k(settings.env.got10k_dir, split=None, image_loader=image_loader))   # 'train_full'-->None, for Anti-UAV
...
def build_dataloaders(cfg, settings):
    ...
    transform_train = tfm.Transform(tfm.ToTensorAndJitter(0.2),        # Jitter表示应用随机抖动，目的是向图像添加随机噪声
