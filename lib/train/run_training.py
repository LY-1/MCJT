...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    prj_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../.."))    # 得到当前文件所在文件的路径，然后往上两级
...
def main():
    ...
    parser.add_argument('--script', type=str, default='ostrack', required=False, help='Name of the train script.')
    parser.add_argument('--config', type=str, default='vitb_384_mae_ce_32x4_got10k_ep100', required=False, help="Name of the config file.")
